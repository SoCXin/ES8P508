...
#define SCU_LVDVS_2V3() (SCU->LVDCON.VS = 0x3)
#define SCU_LVDVS_2V5() (SCU->LVDCON.VS = 0x4)
#define SCU_LVDVS_2V7() (SCU->LVDCON.VS = 0x5)
#define SCU_LVDVS_2V9() (SCU->LVDCON.VS = 0x6)
#define SCU_LVDVS_3V5() (SCU->LVDCON.VS = 0x7)
#define SCU_LVDVS_3V9() (SCU->LVDCON.VS = 0x8)
#define SCU_LVDVS_4V5() (SCU->LVDCON.VS = 0x9)
#define SCU_LVDVS_2V3_2() (SCU->LVDCON.VS = 0xA)
